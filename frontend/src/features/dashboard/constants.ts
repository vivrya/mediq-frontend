...
export const ENROLLED_COURSES = [
  ...
  },
  {
    // Stage 3 — Budding (~58%)
    courseId: "4",
    name: "Pathology: Core Concepts",
    category: "Pathology",
    color: "#7C3AED",
    totalLessons: 16,
    completedLessons: 9,
    enrolledOn: "2026-02-05",
    lastActivityOn: "2026-05-01",
    currentLesson: "Cell Injury & Adaptation",
    estimatedHours: "5h 20m",
    tags: ["NEET PG", "USMLE Step 1"],
  },
  {
    // Stage 4 — Blooming (~80%)
    courseId: "5",
    name: "Medicine: High-Yield Topics",
    category: "Internal Medicine",
    color: "#F59E0B",
    totalLessons: 20,
    completedLessons: 16,
    enrolledOn: "2026-01-10",
    lastActivityOn: "2026-05-04",
    currentLesson: "Diabetic Ketoacidosis",
    estimatedHours: "7h 00m",
    tags: ["NEET PG", "USMLE Step 2"],
  },
  {
    ...
    lastActivityOn: "2026-04-20",
    currentLesson: null,
    estimatedHours: "4h 45m",
    tags: ["NEET PG", "USMLE Step 1"],
  },
];
